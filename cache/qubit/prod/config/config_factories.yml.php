...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'warning',
  'file' => '/usr/share/nginx/atom/log/qubit_prod.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/usr/share/nginx/atom/cache/qubit/prod/template',
  'lifetime' => 86400,
  'prefix' => '/usr/share/nginx/atom/apps/qubit/template',
));
...
if ($parameters = $this->factories['routing']->parse($this->factories['request']->getPathInfo()))
{
  ...
  $class = sfConfig::get('sf_factory_storage', 'QubitCacheSessionStorage');
